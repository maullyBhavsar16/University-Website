    ...
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p> Embark on a transformative educational journey with 
                ...
                curriculum is designed to empower students with the kmowledge,
                skills,a nd experiences needed to excel in the dynamic field of education</p>
            <p>With a focus on innovation, hands-on learning , and personalized
                mentorship,our programs prepare aspiring educators to make a 
                meaningful impact in classrooms,schools,and communitie</p>
